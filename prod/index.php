            ...
            <div class="container" id="container__about">
                    <div class="faux-column grid">
                      <div class="grid-1-2">
                        ...
                        <p>Some of my other interests include action-packed movies, gut-wrenching TV dramas, fast cars, rock climbing, hiking, and building custom computers.</p>
                      </div>
                      <div class="grid-1-2">
                        <h2>My Background</h2>
